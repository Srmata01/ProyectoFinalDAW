...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($query->execute()) {
        echo "Autónomo creado exitosamente.";
    } else {
        echo "Error al crear autónomo.";
    }
}
?>
...
<head>
    ...
    <title>Crear Autónomo</title>
</head>
<body>
<h2>Crear Autónomo</h2>
<form method="POST" action="">
    ...
    <button type="submit">Crear Autónomo</button>
