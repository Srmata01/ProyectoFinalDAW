...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Validar dirección (requerida para autónomos)
    $direccion = trim($_POST['direccion'] ?? '');
    if (!$error && empty($direccion)) {
        $error = "La dirección es obligatoria para profesionales";
    }
   ...
   <div class="app-main">
        <div class="registro-container">
            <div class="registro-form">
                <h1 class="registro-title">Regístrate como Autónomo</h1>
