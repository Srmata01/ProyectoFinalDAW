        ...
        if ($horario) {
            ...
            if ($resultado['conflictos'] == 0) {                // Crear la reserva con estado de confirmación pendiente
                ...
                $stmt->execute([
                  ...
                  // Redirigir al perfil del cliente                $_SESSION['mensaje'] = "Tu reserva ha sido registrada correctamente. El profesional debe confirmarla antes de que sea definitiva.";
